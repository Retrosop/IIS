...
class SiteController extends Controller
{
    ...
    {
        $model = new Zakaz();
        if ($model->load(Yii::$app->request->post()) && $model->zakaz(Yii::$app->params['adminEmail'])) {
            Yii::$app->session->setFlash('zakazFormSubmitted');
	...
	public function actionVistovka()
    {
        return $this->render('vistovka');
	}
